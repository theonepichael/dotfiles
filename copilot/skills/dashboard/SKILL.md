...
Display both outputs verbatim — do not narrate, do not reformat. The item-map on stderr is for you, not the user: use it to resolve natural language ("mark 3 done", "work on 2") into the copilot-instructions.md backlog commands, passing the integer N straight through.

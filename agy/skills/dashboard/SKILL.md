...
Display both outputs verbatim — do not narrate, do not reformat. The item-map on stderr is for you, not the user: use it to resolve natural language ("mark 3 done", "work on 2") into the shared instructions file's backlog commands, passing the integer N straight through.

...
<!-- generated by claude/scripts/gen_core_instructions.py — do not edit; edit claude/CORE_INSTRUCTIONS.md (shareable) or claude/personal-overlay.md (this machine's personal policy) instead, then regenerate -->

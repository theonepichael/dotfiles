...
or the "visible in the current conversation" fallback — write it to a file in
the scratchpad directory first, and use that path as `current_plan` for the
rest of this skill. Never pass inline plan text to `second_opinion.py
